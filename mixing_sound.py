...
utl.plotSounds([mixedX, mixedY], ["mixedX","mixedY"], rate1, "Ring_StarWars_mixed", False)

# Save the mixed sources as wav files
wavfile.write("./sounds/mixedX.wav", rate1, mixedX)
wavfile.write("./sounds/mixedY.wav", rate1, mixedY)